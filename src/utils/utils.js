...
export const checkIfMonthHasToBeDisplayed = (
  ...
  //if the month is already in monthsAlreadyDisplayed,
  //return true to display it,or false to pass next AND the month to display
  if (monthsAlreadyDisplayed.includes(monthToCompare)) {
    valuesToReturn.push(false);
    return valuesToReturn;
  } else {
    monthsAlreadyDisplayed.push(monthToCompare);
