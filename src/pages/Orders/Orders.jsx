...
const Orders = () => {
  ...
  const onSuccessDeleteOrder = (data) => {
    refetch();
    displayInfoMessage(" Vous ordre a été supprimé", "#333A56");
  };
        ...
        <tbody>
          <tr>
            ...
            <td>
              <input
                type="number"
                className={`Orders-taille ${!taille ? "empty" : "checked"}`}
                name="taille"
                value={taille}
            ...
            <td>
              <input
                type="number"
                className={`Orders-risk ${!risk ? "empty" : "checked"}`}
                name="risk"
                value={risk}
            ...
            <td></td>
            <td>
              <button onClick={creationOrder} className="Orders-actions_button">
                Ajouter
              </button>
            </td>
          </tr>
